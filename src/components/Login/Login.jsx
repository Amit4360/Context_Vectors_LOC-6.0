...
const LoginForm = () => {
  ...
  return (
    <div className='w-full flex flex-row justify-center sm-flex-col h-[450px]'>
      ...
      <form class="w-full h-[450px] text-[16px] mr-[40px] flex flex-col items-center justify-center">
        ...
        <button type="submit" class="flex justify-center align-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg  w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
        </div>
