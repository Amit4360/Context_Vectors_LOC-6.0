    ...
    <div className='w-full flex flex-row sm-flex-col'>
      <div className="hidden md:flex flex-col w-full justify-center items-center ">
        <Lottie
          ...
          className="flex justify-center items-center min-w-[200px] max-w-[400px] mx-[40px]"
          loop={true}
        />
      </div>
      <form class="w-full">
        ...
        <p id="helper-text-explanation" class="m-2 text-sm text-gray-500 dark:text-gray-400">We’ll never share your details. Read our <a href="#" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Privacy Policy</a>.</p>
        <div className='w-full flex items-center justify-center'>
        <button type="submit" class="flex justify-center align-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign Up</button>
        </div>
